...
const Footer = () => {
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image src={Logo} alt="MR X Store Logo" width={64} height={64} />
          ...
          <div className="justify-self-center">
            ...
            <div className="flex items-center gap-4">
              <a target="_blank" href="https://www.facebook.com/profile.php?id=61550064407218" rel="noopener noreferrer">
                <FaFacebook className="text-3xl hover:text-primary" />
              </a>
              <a target="_blank" href="https://www.instagram.com/example" rel="noopener noreferrer">
                <FaInstagram className="text-3xl hover:text-primary" />
              </a>
              <a target="_blank" href="https://www.tiktok.com/@example" rel="noopener noreferrer">
                <FaTiktok className="text-3xl hover:text-primary" />
              </a>
              <a href="tel:+21624312982">
                <FaMobileAlt className="text-3xl hover:text-primary" />
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li className="hover:text-primary duration-300">
                  <Link href="/useragreement">Terms and Conditions</Link>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div className="rounded-xl overflow-hidden  relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl mt-8">
    <div className="text-gray-500 group-hover:scale-105 transition-all">
      <svg className="w-16 h-16 group-hover:text-primary" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="flex items-center transition-all duration-500 delay-200 group-hover:bottom-3 -bottom-full absolute gap-2 justify-evenly w-full">
      <div className="flex gap-3 text-2xl bg-gray-700 text-white p-1 hover:p-2 transition-all duration-500 delay-200 rounded-full shadow-sm">
        <a target='_blank' href="https://github.com/LADYGRAY95" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-500 delay-200 hover:text-primary">
        ...
        <a target='_blank' href="mailto:cyoussr@gmail.com" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-500 delay-200 hover:text-primary">
          <svg width="1em" height="1em" viewBox="0 0 24 24" stroke="currentColor" fill="none">
            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
            <path d="M22 6l-10 7L2 6"></path>
          </svg>
        </a>
        <a target='_blank' href="https://www.linkedin.com/in/youssr-chouaya-63a54929a/" rel="noopener noreferrer" className="hover:scale-110 transition-all duration-500 delay-200 hover:text-primary">
